...
describe("Firestore access rules", () => {
    ...
    beforeAll(async () => {
        testEnv = await (0, rules_unit_testing_1.initializeTestEnvironment)({
            ...
            firestore: {
                rules: node_fs_1.default.readFileSync(node_path_1.default.resolve(__dirname, "../../../firestore.rules"), "utf8"),
            },
        });
    });
    afterAll(async () => {
    ...
    it("allows a representative to read only an assigned request", async () => {
        await testEnv.withSecurityRulesDisabled(async (context) => {
            await (0, firestore_1.setDoc)((0, firestore_1.doc)(context.firestore(), "requests/REQ-1"), {
                requestId: "REQ-1",
                status: "Published",
        ...
        await (0, rules_unit_testing_1.assertSucceeds)((0, firestore_1.getDoc)((0, firestore_1.doc)(rep.firestore(), "requests/REQ-1")));
        await (0, rules_unit_testing_1.assertFails)((0, firestore_1.getDoc)((0, firestore_1.doc)(otherRep.firestore(), "requests/REQ-1")));
    });
    it("rejects direct workflow writes by administrators", async () => {
        const admin = testEnv.authenticatedContext("admin-1", { role: "ADMIN" });
        await (0, rules_unit_testing_1.assertFails)((0, firestore_1.setDoc)((0, firestore_1.doc)(admin.firestore(), "requests/REQ-2"), {
            requestId: "REQ-2",
            status: "Draft",
        }));
    });
