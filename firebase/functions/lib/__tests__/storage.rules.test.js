...
describeIfStorageRules("Storage access rules", () => {
    ...
    testEnv = await (0, rules_unit_testing_1.initializeTestEnvironment)({
      ...
      storage: {
        rules: node_fs_1.default.readFileSync(
          node_path_1.default.resolve(__dirname, "../../../storage.rules"),
          "utf8",
        ),
      },
    });
  ...
  it("allows a representative to upload to their own upload path", async () => {
    ...
    await (0, rules_unit_testing_1.assertSucceeds)(
      (0, storage_1.uploadBytes)(
        (0, storage_1.ref)(storage, "uploads/REQ-1/REC-1/rep-1/report.csv"),
  ...
  it("blocks uploads outside the owner's path and rejects invalid file types", async () => {
    ...
    await (0, rules_unit_testing_1.assertFails)(
      (0, storage_1.uploadBytes)(
        (0, storage_1.ref)(
          otherRep.storage(),
          "uploads/REQ-1/REC-1/rep-1/report.csv",
        ),
        new Blob(["id,name\n1,Test"], { type: "text/csv" }),
      ),
    );
    await (0, rules_unit_testing_1.assertFails)(
      (0, storage_1.uploadBytes)(
        (0, storage_1.ref)(
          rep.storage(),
          "uploads/REQ-1/REC-1/rep-1/report.json",
        ),
  ...
  it("allows admins to import files and blocks direct deletes or updates", async () => {
    ...
    await (0, rules_unit_testing_1.assertSucceeds)(
      (0, storage_1.uploadBytes)(
        (0, storage_1.ref)(admin.storage(), "imports/REQ-1/IMP-1/users.csv"),
        new Blob(["name\nAlice"], { type: "text/csv" }),
      ),
    );
    await (0, rules_unit_testing_1.assertFails)(
      (0, storage_1.uploadBytes)(
        (0, storage_1.ref)(rep.storage(), "imports/REQ-1/IMP-2/users.csv"),
        new Blob(["name\nAlice"], { type: "text/csv" }),
      ),
    );
    const importRef = (0, storage_1.ref)(
      admin.storage(),
      "imports/REQ-1/IMP-1/users.csv",
    );
    await (0, rules_unit_testing_1.assertFails)(
      (0, storage_1.deleteObject)(importRef),
    );
  });
});
