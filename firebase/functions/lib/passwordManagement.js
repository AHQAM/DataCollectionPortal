...
exports.changePassword = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const isCurrentValid = await (0, auth_1.verifyPassword)(
      currentPassword,
    ...
    const isSameAsCurrent = await (0, auth_1.verifyPassword)(
      newPassword,
      userData.passwordHash,
    );
    if (isSameAsCurrent) {
 ...
 */
exports.requestPasswordReset = functions.https.onCall(
  async (data, _context) => {
