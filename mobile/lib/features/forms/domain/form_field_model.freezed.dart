...
int get hashCode {
  final _this = this as FormFieldModel;
  return Object.hash(runtimeType,_this.id,_this.type,_this.labelAr,_this.labelEn,_this.isRequired,const DeepCollectionEquality().hash(_this.options),_this.validationRegex,_this.validationMessageAr,_this.validationMessageEn,_this.isReadOnly,_this.minLength,_this.maxLength,_this.minValue,_this.maxValue,_this.orderIndex);
}

@override
String toString() {
  final _this = this as FormFieldModel;
  return 'FormFieldModel(id: ${_this.id}, type: ${_this.type}, labelAr: ${_this.labelAr}, labelEn: ${_this.labelEn}, isRequired: ${_this.isRequired}, options: ${_this.options}, validationRegex: ${_this.validationRegex}, validationMessageAr: ${_this.validationMessageAr}, validationMessageEn: ${_this.validationMessageEn}, isReadOnly: ${_this.isReadOnly}, minLength: ${_this.minLength}, maxLength: ${_this.maxLength}, minValue: ${_this.minValue}, maxValue: ${_this.maxValue}, orderIndex: ${_this.orderIndex})';
}
...
@useResult
$Res call({
 String id, String type, String labelAr, String labelEn, bool isRequired, List<String>? options, String? validationRegex, String? validationMessageAr, String? validationMessageEn, bool isReadOnly, int? minLength, int? maxLength, double? minValue, double? maxValue, int orderIndex
});
...
/// Create a copy of FormFieldModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? labelAr = null,Object? labelEn = null,Object? isRequired = null,Object? options = freezed,Object? validationRegex = freezed,Object? validationMessageAr = freezed,Object? validationMessageEn = freezed,Object? isReadOnly = null,Object? minLength = freezed,Object? maxLength = freezed,Object? minValue = freezed,Object? maxValue = freezed,Object? orderIndex = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String type,  String labelAr,  String labelEn,  bool isRequired,  List<String>? options,  String? validationRegex,  String? validationMessageAr,  String? validationMessageEn,  bool isReadOnly,  int? minLength,  int? maxLength,  double? minValue,  double? maxValue,  int orderIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FormFieldModel() when $default != null:
return $default(_that.id,_that.type,_that.labelAr,_that.labelEn,_that.isRequired,_that.options,_that.validationRegex,_that.validationMessageAr,_that.validationMessageEn,_that.isReadOnly,_that.minLength,_that.maxLength,_that.minValue,_that.maxValue,_that.orderIndex);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String type,  String labelAr,  String labelEn,  bool isRequired,  List<String>? options,  String? validationRegex,  String? validationMessageAr,  String? validationMessageEn,  bool isReadOnly,  int? minLength,  int? maxLength,  double? minValue,  double? maxValue,  int orderIndex)  $default,) {final _that = this;
switch (_that) {
case _FormFieldModel():
return $default(_that.id,_that.type,_that.labelAr,_that.labelEn,_that.isRequired,_that.options,_that.validationRegex,_that.validationMessageAr,_that.validationMessageEn,_that.isReadOnly,_that.minLength,_that.maxLength,_that.minValue,_that.maxValue,_that.orderIndex);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String type,  String labelAr,  String labelEn,  bool isRequired,  List<String>? options,  String? validationRegex,  String? validationMessageAr,  String? validationMessageEn,  bool isReadOnly,  int? minLength,  int? maxLength,  double? minValue,  double? maxValue,  int orderIndex)?  $default,) {final _that = this;
switch (_that) {
case _FormFieldModel() when $default != null:
return $default(_that.id,_that.type,_that.labelAr,_that.labelEn,_that.isRequired,_that.options,_that.validationRegex,_that.validationMessageAr,_that.validationMessageEn,_that.isReadOnly,_that.minLength,_that.maxLength,_that.minValue,_that.maxValue,_that.orderIndex);case _:
  return null;
...
class _FormFieldModel implements FormFieldModel {
  const _FormFieldModel({required this.id, required this.type, required this.labelAr, required this.labelEn, this.isRequired = true,  List<String>? options, this.validationRegex, this.validationMessageAr, this.validationMessageEn, this.isReadOnly = false, this.minLength, this.maxLength, this.minValue, this.maxValue, this.orderIndex = 0}): _options = options;
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,type,labelAr,labelEn,isRequired,const DeepCollectionEquality().hash(_options),validationRegex,validationMessageAr,validationMessageEn,isReadOnly,minLength,maxLength,minValue,maxValue,orderIndex);
}

@override
String toString() {
    return 'FormFieldModel(id: $id, type: $type, labelAr: $labelAr, labelEn: $labelEn, isRequired: $isRequired, options: $options, validationRegex: $validationRegex, validationMessageAr: $validationMessageAr, validationMessageEn: $validationMessageEn, isReadOnly: $isReadOnly, minLength: $minLength, maxLength: $maxLength, minValue: $minValue, maxValue: $maxValue, orderIndex: $orderIndex)';
}
...
/// Create a copy of FormFieldModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = null,Object? labelAr = null,Object? labelEn = null,Object? isRequired = null,Object? options = freezed,Object? validationRegex = freezed,Object? validationMessageAr = freezed,Object? validationMessageEn = freezed,Object? isReadOnly = null,Object? minLength = freezed,Object? maxLength = freezed,Object? minValue = freezed,Object? maxValue = freezed,Object? orderIndex = null,}) {
