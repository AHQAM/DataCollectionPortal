...
describe('AdminReports Components', () => {
  it('renders ReportFilters correctly', () => {
    const mockRequests = [{ requestId: 'req1', requestCode: 'RQ-001', titleEn: 'Test Request', titleAr: 'طلب تجريبي' } as any];
    const mockBranches = [{ branchId: 'br1', branchNameEn: 'Branch A', branchNameAr: 'الفرع الأول' } as any];
  ...
  it('renders ReportAnalysisCharts correctly and computes percentages', () => {
    const mockChoiceFields = [{ fieldKey: 'q1', fieldLabelEn: 'Question 1', fieldType: 'select' } as any];
    ...
    expect(screen.getByText('Field Responses Distribution Analysis')).toBeTruthy();
