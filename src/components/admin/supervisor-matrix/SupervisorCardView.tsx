    ...
    return (
      <div className="p-12 text-center bg-white rounded-3xl border border-slate-200">
        ...
        <h3 className="text-sm font-black text-slate-700">
          {t("supervisors.cards.emptyTitle", { lng: currentLang })}
        </h3>
        <p className="text-xs text-slate-400 mt-1">
          {t("supervisors.cards.emptyDesc", { lng: currentLang })}
        </p>
      </div>
    );
  }
        ...
        return (
          ...
          >
            ...
            <div className="p-5 bg-gradient-to-r from-slate-50 via-purple-50/20 to-white border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500 mt-1 font-medium">
                    <span>
                      {t("supervisors.cards.empNo", { lng: currentLang })}
                    ...
                    <span>•</span>
                    <span>
                      {t("supervisors.cards.primaryBranch", {
                        lng: currentLang,
                      })}
              ...
              <div className="flex flex-wrap items-center gap-2">
                <div className="px-3 py-1.5 bg-purple-100 text-purple-950 rounded-xl text-xs font-black">
                  {t("supervisors.cards.coverageStatus", {
                ...
                <button
                  ...
                  title={t("supervisors.cards.grantAllTitle", {
                    lng: currentLang,
                  })}
                >
                  {t("supervisors.cards.grantAllBtn", { lng: currentLang })}
                </button>
                ...
                <button
                  ...
                  title={t("supervisors.cards.clearAllTitle", {
                    lng: currentLang,
                  })}
                >
                  {t("supervisors.cards.clearAllBtn", { lng: currentLang })}
                </button>
              </div>
            </div>
            ...
            <div className="p-5 space-y-5">
              {branches.map((branch) => {
                const branchRegions = regions.filter(
                  (r) => r.branchId === branch.branchId,
                );
                if (branchRegions.length === 0) return null;

                const branchAssignedCount = branchRegions.filter((r) =>
                  allowedNos.has(r.regionNo),
                ).length;
                const isAllInBranch =
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-slate-200/60 mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[11px] font-bold text-slate-500">
                          ({branchAssignedCount}/{branchRegions.length}{" "}
                          {t("supervisors.cards.zonesCount", {
                            lng: currentLang,
                          })}
                          )
                        </span>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          type="button"
                          onClick={() =>
                            onSelectAllInBranch(supervisor, branch.branchId)
                          }
                        ...
                        >
                          ...
                          <span>
                            {t("supervisors.cards.selectAllBranch", {
                              lng: currentLang,
                            })}
                          </span>
                        </button>
                        ...
                        <button
                          type="button"
                          onClick={() =>
                            onDeselectAllInBranch(supervisor, branch.branchId)
                          }
                        ...
                        >
                          ...
                          <span>
                            {t("supervisors.cards.deselectBranch", {
                              lng: currentLang,
                            })}
                          </span>
                        </button>
                      ...
                      {branchRegions.map((region) => {
                        ...
                        return (
                          <label
                            key={region.regionId}
                            onClick={() =>
                              onToggleRegion(supervisor, region.regionNo)
                            }
