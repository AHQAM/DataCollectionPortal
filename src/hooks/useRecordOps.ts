      ...
      if (!isOnline) {
        try {
          ...
          return {
            success: true,
            isOffline: true,
            message: i18n.t("recordOps.draftSavedOffline", { lng: lang }),
          };
        } catch (queueErr) {
      ...
      try {
        ...
        if (res.conflict) {
          ...
          return {
            success: true,
            conflict: true,
            message: i18n.t("recordOps.draftConflictResolved", { lng: lang }),
          };
        }
      ...
      if (!isOnline) {
        try {
          ...
          return {
            success: true,
            isOffline: true,
            message: i18n.t("recordOps.submittedOffline", { lng: lang }),
          };
        } catch (queueErr) {
          return {
            success: false,
        ...
        if (res.success) {
          if (res.conflict) {
            ...
            return {
              success: true,
              conflict: true,
              message: i18n.t("recordOps.conflictResolved", { lng: lang }),
            };
          }
          ...
          return {
            success: true,
            message: i18n.t("recordOps.savedAndSubmitted", { lng: lang }),
          };
        }
        return {
          success: false,
